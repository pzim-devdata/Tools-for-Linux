...
[Tray_icon_desktop](https://github.com/pzim-devdata/shortcuts-for-Linux/tree/main/Tray_icons_desktop): A tray icon that offers quick access to the desktop environment, allowing you to show or hide the desktop with a single click.
